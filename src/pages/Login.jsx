  ...
  return (
    ...
    <div className="bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
        <div className="md:w-1/2 px-8">
            ...
            <Link to="/register"> <button className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300" aria-label="Register a new account" title="Register" > Register </button> </Link>
        </div>
