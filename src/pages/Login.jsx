            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="relative">
                ...
                <svg
                  ...
                  height="16"
                  fill="gray"
                  className={`bi bi-eye absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer z-20 opacity-100 ${showPassword ? 'hidden' : ''}`}
                ...
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className={`bi bi-eye-slash-fill absolute top-1/2 right-3 -z-1 -translate-y-1/2 cursor-pointer ${showPassword ? '' : 'hidden'}`}
                  onClick={togglePasswordVisibility}
                  viewBox="0 0 16 16"
                >
